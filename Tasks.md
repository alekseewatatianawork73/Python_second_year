...
```
------------------------------------------------------------------------------------------------
3. Дополните предыдущую программу: создайте ещё один класс PhoneAcc с информацией о балансе на телефоне и с двумя методами для пополнения счёта и для оплаты какой-либо услуги. Удалите из класса BankAcc метод get_balance() и сделайте его полиморфной функцией для вывода баланса на экран.
